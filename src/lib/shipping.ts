...
export interface Outlier {
  id: string; site: string; shipbob_order_id: string; order_number: string | null;
...
export const shipbobOrderUrl = (id: string) => `https://web.shipbob.com/app/merchant/#/orders/${id}`;
