...
- Once required fields are in hand, call send_influencer_gift (creates the ShipBob B2C order + right box + logs to dashboard). ALWAYS report back EXACTLY what was added. Only ask Kate when a REQUIRED field is truly missing/ambiguous. size_g 520 is the usual gift; site ALTONA=AU, MANCHESTER=UK.
