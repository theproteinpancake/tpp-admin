...
const GROUPS: Group[] = [
  { label: 'Sales channels', metrics: [
    ...
    { key: 'cr', label: 'CR', fmt: 'pct', dir: 'high', agg: 'avg', editable: true },
    ...
    { key: 'nz_cr', label: 'NZ CR', fmt: 'pct', dir: 'high', agg: 'avg', editable: true },
    { key: 'nz_aov', label: 'NZ AOV', fmt: 'money2', dir: 'high', agg: 'avg' },
    { key: 'orders_uk', label: 'UK ord', fmt: 'num', dir: 'high', agg: 'sum' },
    { key: 'uk_cr', label: 'UK CR', fmt: 'pct', dir: 'high', agg: 'avg', editable: true },
